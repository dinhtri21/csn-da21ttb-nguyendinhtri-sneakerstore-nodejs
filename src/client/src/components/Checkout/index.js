...
function Checkout({ products, handleGetProductsCart }) {
  ...
  const handleSubmit = (event) => {
    ...
    const axiosCheckOut = async () => {
      await axios
        .post(`https://${process.env.REACT_APP_API_URL}:${process.env.REACT_APP_API_PORT}/order`, orderData)
        .then((response) => {
  ...
  const ClearCart = async () => {
    axios
      .post(`https://${process.env.REACT_APP_API_URL}:${process.env.REACT_APP_API_PORT}/cart/clearProductCart`, [], {
